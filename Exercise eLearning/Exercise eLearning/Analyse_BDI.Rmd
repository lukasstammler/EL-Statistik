...
knitr::opts_chunk$set(fig.align = "center") ### LS
```
...
![*Datensatz Beat the blues in jamovi mit korrekt hinterlegten Datentypen*](../images/jmv_variables.png)
...
![*Deskriptive Statistik - Vergleich der Gruppen zu Beginn der Studie*](../Images/jmv_bdi_pre.png)   
...
![*Deskriptive Statistik - Vergleich der Gruppen zu Beginn der Studie*](../Images/jmv_table.png)
...
![*Boxplots der bdi_pre-Werte nach Gruppe*](../Images/jmv_boxplots.png)
...
![*Erstellen der Variable bdi_diff*](../Images/jmv_bdi_diff.png)
<br>   
...
Um wie viel hat sich die vierte Person von der Baseline (`bdi_pre`) bis zur letzten Messung (`bdi_8m`) verbessert/verschlechtert?
...
Wir sehen, dass sich die vierte Person um 10 Punkte verbessert hat (der Score nimmt ab, also hat sich die Depression verbessert).   
...
![*Durchschnittliche Veränderung des BDI-Scores von der Baseline bis zur Messung nach 8 Monaten*](../Images/jmv_mean_bdi_diff.png)   
...
![*qq-Plots der paarweisen Differenzen*](../Images/jmv_qqplot_dpnd_tTest.png)
...
![*Filter um nur die BtheB Gruppe zu analysieren*](../Images/jmv_filter_btheb.png)   
...
![*t-Test für abhängige Stichproben für die mittlere Veränderung des BDI-Scores in der BtheB Gruppe*](../Images/jmv_dpnd_tTest_BtheB.png)   

<br>   

**Interpretation**    

Die mittlere Differenz zwischen den beiden Zeitpunkten beträgt in der BtheB Gruppe 13.1 Punkte. Unter dem Szenario, dass H0 wahr ist, ist die Wahrscheinlichkeit (also der p-Werte), eine Teststatistik t von 6.8 bei einer t-Verteilung mit 26 Freiheitsgeraden zu finden, sehr klein (kleiner als 0.1%). Bei einem Signifikanzniveau von 5% fällt die Teststatistik t somit in den Verwerfungsbereich. Folglich wird H0 zugunsten von HA verworfen.
Wir können zu 95% darauf vertrauen, dass die wahre mittlere Differenz irgendwo zwischen 9.18 und 17.1 Punkten liegt. Die Daten liefern also Evidenz dafür, dass sich der BDI-Score in der BtheB Gruppe verbessert.
...
![*t-Test für abhängige Stichproben für die mittlere Veränderung des BDI-Scores in der TAU Gruppe*](../Images/jmv_dpnd_tTest_TAU.png)   
...
Stellen Sie die Variable `bdi_diff` mittels Boxplots sepparat pro Gruppe dar. Würden Sie aufgrund dieser Darstellung einen statistisch signifikanten Unterschied zwischen den Gruppen erwarten? Mit welchem statistischen Test/Verfahren können Sie dies prüfen?   
...
![*Darstellung der Differenz zwischen der Baseline und dem Follow-up nach 8 Monaten nach Gruppe*](../Images/jmv_boxplots_between_groups.png)   
...
![*qq-Plots der Variable bdi_diff*](../Images/jmv_qqplot_dpnd_tTest.png)
...
![*Einfache lineare Regression mit `bdi_diff` und `bdi_pre`*](../Images/jmv_slr_res.png){width=70%}
...
![*Einfaches lineare Regressionsmodell in jamovi*](../Images/jmv_slr_settings.png)
...
![*Scatterplot mit `bdi_pre` und `bdi_diff`*](../Images/jmv_scatterplot_pre_diff.png)
...
9. Das Modell schätzt für eine Person, welche zu Beginn der Studie einen BDI-Score von 30 hat, eine durchschnittliche Verbesserung von 16.3 Punten. Diese Aussage ist **KORREKT**. Die Regressionsformel lautet $\beta_0 + \beta1 * x = -2.586 + 0.629 * 30 = 16.284$.   
...
![*Erstellung der Variable `mcid`*](../Images/jmv_mcid.png)
...
![*Absolute Häufigkeiten der Variable `mcid`*](../Images/jmv_table_mcid.png)
...
![*Chi-Quadrat Test*](../Images/jmv_x2_test.png)
<br>   
...
Falls Sie die Originalstudie gelesen haben wir Ihnen aufgefallen sein, dass dort von einem "statistisch signifikanten" Unterschied zwischen den Gruppen die Rede ist. Haben Sie in dieser Übung nun doch alles falsch gerechnet? Nein! Es gibt mehrere Gründe, warum die Origanstudie zu (leicht) unterschiedlichen Resultaten kommt:   
...
* In der Studie wird der Zeitpunkt nach 8 Monaten nur halbpatzig berücksichtig (siehe z.B. Tabelle unten). Warum wohl? Wenn sie einen t-Test machen für BDI-Score nach 6 Monaten werden Sie einen signifikanten Unterschied zwischen den Gruppen feststellen, jedoch nicht nach 8 Monaten!

![Auszug aus der Studie](../Images/Screenshot_Studie.png){width=50%}
