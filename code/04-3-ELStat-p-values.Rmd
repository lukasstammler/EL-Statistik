---
title: 'Inferenzstatistik: p-Werte berechnen'
...
Der R-Code in den grau unterlegten Feldern kann mittels Copy-Paste in den `Rj-Editor` eingegeben werden. Ausführen des Codes dem grünen Pfeil oben rechts im `Rj-Editor`-Fenster.   
...
In `Rj-Editor` sieht das dann so aus (z.B. für $z$ = -2.4):   
